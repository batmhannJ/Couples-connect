...
Class pager extends db_init{
    ...
    //alert settings
    public $alert_del;
    public $alert_del_field;
    public $alert_del_dd_field_val;
    public $alert_del_dd_tablename;
    ...
    public $exp_pdf;
    public $exp_txt;
    public $exp_txt_filename;

    //for custom
    public $save_page;
    public $txt_pager_pageno_hidden;
    public $search_hidden_save_input;
    public $search_hidden_save_dd;
    public $check_search_save;
    public $search_current_dd;
    public $search_current_input;
    public $event_save_hidden;
    public $datatype_hidden;
    public $search_current_dd_field;
    public $search_current_dd_field_val;
    public $search_current_dd_table;
    public $search_event_action;
    public $search_event_action2;
    ...
    public function display_table(){
        ...
        if(($this->display_only !== "Y"|| empty($this->display_only)) && (int)$this->add_crud !== 0){
            echo "<h2>".$this->main_header."</h2><div class='sql_echo'></div>";
        }
        ...
        echo "<input type='hidden' name='alert_del_field' id='alert_del_field' value='".$this->alert_del_field."'>";
        echo "<input type='hidden' name='alert_del_dd_field_val' id='alert_del_dd_field_val' value='".$this->alert_del_dd_field_val."'>";
        echo "<input type='hidden' name='alert_del_dd_tablename' id='alert_del_dd_tablename' value='".$this->alert_del_dd_tablename."'>";
        ...
        //for txt/xls filename
        echo "<input type='hidden' name='filename_export_hidden' id='filename_export_hidden' value='".$this->exp_txt_filename."'>";
        ...
        echo "<input type='hidden' name='check_search' id='check_search'>";

        
        echo "<input type='hidden' name='txt_output_type' id='txt_output_type'>";
        echo "<input type='hidden' name='ua_field1_header_hidden' id='ua_field1_header_hidden' value='".$this->alert_del_field."'>";


        //for saving page no.
        if($this->save_page == "Y"){
            echo "<input type='hidden' name='txt_pager_pageno_hidden' id='txt_pager_pageno_hidden' value='".$this->txt_pager_pageno_hidden."'>";
            echo "<input type='hidden' name='search_hidden_save_input' id='search_hidden_save_input' value='".$this->search_hidden_save_input."'>";
            echo "<input type='hidden' name='search_hidden_save_dd' id='search_hidden_save_dd'  value='".$this->search_hidden_save_dd."'>";
            echo "<input type='hidden' name='check_search2' id='check_search2'  value='".$this->check_search_save."'>";
            echo "<input type='hidden' name='search_current_dd' id='search_current_dd'  value='".$this->search_current_dd."'>";
            echo "<input type='hidden' name='search_current_input' id='search_current_input'  value='".$this->search_current_input."'>";
            echo "<input type='hidden' name='event_save_hidden' id='event_save_hidden'  value='".$this->event_save_hidden."'>";
            echo "<input type='hidden' name='datatype_hidden' id='datatype_hidden' value='".$this->datatype_hidden."'>";
            echo "<input type='hidden' name='search_current_dd_field' id='search_current_dd_field' value='".$this->search_current_dd_field."'>";
            echo "<input type='hidden' name='search_current_dd_field_val' id='search_current_dd_field_val' value='".$this->search_current_dd_field_val."'>";
            echo "<input type='hidden' name='search_current_dd_table' id='search_current_dd_table' value='".$this->search_current_dd_table."'>";
            echo "<input type='hidden' name='search_event_action' id='search_event_action' value='".$this->search_event_action."'>";
            echo "<input type='hidden' name='search_event_action2' id='search_event_action2' value='".$this->search_event_action2."'>";
                                ...
                                echo "<div class='row m-3' id='crudModal_values'>";
                                    echo "<div class='col-12'>";
                                            ...
                                            if(isset($step_limit)){
                                                ...
                                                onkeypress='return onlyNumberKeyWDecimal(event)'
                                                >";
            ...
            <div class='modal-dialog'>
                <div class='modal-content'>";
                    ...
                    <div class='modal-body'>
                        <span>Are you sure you want to delete <span style='font-weight:bold' class='modalDelField'></span><span style='font-weight:bold'>'s</span> record?</span>
                    </div>
