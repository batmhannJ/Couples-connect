...
require_once('resources/connect4.php');
    ...
    mf_appointment_info.userid = mf_prog_users.userid LEFT JOIN mf_venue ON ext_appointment_info.venue_id = mf_venue.venue_id WHERE ext_appointment_info.counseloremail = '".$rs_email['email']."' ";
