...
* Use either custom or theme colors pallete
* Custom Margin, Padding, and Colors option
* **Unlimited accordion items**
* **All blocks are supported to design accordion body content**
...
1. Use the Settings->easy-accordion-block screen to configure the plugin
