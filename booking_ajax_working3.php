        ...
        $ret['html'].= "<tr>";
            ...
            if($_POST['event_action'] == 'first_load'){
                ...
                if($_POST['event_action'] == 'changeDate'){
                    $select_db_times2 = "SELECT ext_appointment_info.time_from as 'time_from', ext_appointment_info.time_to as 'time_to'  FROM ext_appointment_info LEFT JOIN mf_appointment_info ON
        ...
        $ret['html'].= "<tr>";
            ...
            if($_POST['ext_recid'] == $row_xid['ext_recid']){
                ...
                $ret['html'].= "<td>";
                    ...
                    $stmt_times	= $link->prepare($select_db_times2);
                    $stmt_times->execute();
                    $selected_timeline = '';
