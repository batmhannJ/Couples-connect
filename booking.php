...
<div class="container-fluid">
    ...
    <form name='myforms' id="myforms" method="post" target="_self" style='height:100%'> 
                ...
                <td class="d-flex align-items-top mx-0 px-0">
                    <div class="container-fluid pt-4 d-flex justify-content-center" style="width:100%;">
                        <table id="table_data" name="table_data" style='background-color:white;border-radius:15px;width:92%'>
                            ...
                            ext_appointment_info.appointment_info_id   = mf_appointment_info.appointment_info_id LEFT JOIN mf_venue ON ext_appointment_info.venue_id = mf_venue.venue_id WHERE mf_venue.venue!='' AND mf_appointment_info.sched_type='".$act_status2."'  GROUP BY mf_venue.venue_id ";
                                ...
                                echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<select class='form-control w-75 ms-2 select_date'>";
                                                ...
                                                mf_appointment_info.userid = mf_prog_users.userid LEFT JOIN mf_venue ON ext_appointment_info.venue_id = mf_venue.venue_id  WHERE mf_venue.venue='".$row_xid['venue']."' AND mf_appointment_info.sched_type='".$act_status2."' GROUP BY ext_appointment_info.clinic_date";
        ...
        <div class="modal fade meiform_modal" id="meiform_modal" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
            <div class="modal-dialog modal-dialog modal-xl  modal-dialog-scrollable" style='max-width:1200px;max-height:1100px'>
                ...
                <div class="modal-body">
                        ...
                        <div class="row"> 
                          <div class="checkout-wrap col-sm-12 col-xs-12">
                            <ul class="checkout-bar">
                              <li class="active"><a href="#about-you" data-toggle="tab">Josh Bryce Cremin Pacocha</a></li>
                              <li class="active"><a href="#looking-for" data-toggle="tab">Josh Bryce Cremin Pacocha</a></li>
                            </ul>
                          </div>
                        </div>
                                        ...
                                        echo '
                                            <div style="display:flex; gap: 23px; width: 202px;font-weight: bold;">
                                                <div class="form-check">
                                                  <input class="form-check-input" value="Agree" type="radio" name="form_1['.$mei_form1_counter.'][option]" id="flexRadioDefault3">
                                                  <label class="form-check-label" for="flexRadioDefault3">
                                                    Agree
                                                  </label>
                                                </div>
                                                <div class="form-check">
                                                  <input class="form-check-input" value="Disagree" type="radio" name="form_1['.$mei_form1_counter.'][option]" id="flexRadioDefault4">
                    ...
                    <div class='partner2_modal' id='partner2_modal' style='display:none'>
                        ...
                        <div class="row"> 
                          <div class="checkout-wrap col-sm-12 col-xs-12">
                            <ul class="checkout-bar">
                              <li class="visited"><a href="#about-you" data-toggle="tab">Josh Bryce Cremin Pacocha</a></li>
                              <li class="visited"><a href="#looking-for" data-toggle="tab">Josh Bryce Cremin Pacocha</a></li>
                            </ul>
                          </div>
                        </div>
                                    ...
                                    echo "<tr style='margin-top:5px'>";
                                        ...
                                        echo "<td class='px-3'>";
                                            echo '
                                                <div style="display:flex; gap: 23px; width: 202px;font-weight: bold;">
                                                    <div class="form-check">
                                                      <input class="form-check-input" value="Agree" type="radio" name="form_2['.$mei_form2_counter.'][option]" id="flexRadioDefault1">
                                                      <label class="form-check-label" for="flexRadioDefault1">
                                                        Agree
                                                      </label>
                                                    </div>
                                                    <div class="form-check">
                                                      <input class="form-check-input" value="Disagree" type="radio" name="form_2['.$mei_form2_counter.'][option]" id="flexRadioDefault2">
    ...
    <script>
        ...
        function proceed_partner2(){
            if(checkDropdownsInModal('partner1_modal')){
        ...
        const back_form = () => {
              $("#partner1_modal").css({'display': 'block'});
