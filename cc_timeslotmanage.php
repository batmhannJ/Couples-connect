...
?>
    ...
    <table style="width:100%;height:100%;background-color:#f2f2f2">
            <tr>
                ...
                <td style='width:70%'>
                    <div class="row h-100 justify-content-center align-items-center">
                        <div style='width:1025px;height:700px;background-color:white;border-radius:30px;filter: drop-shadow(0px 4px 15px rgba(0, 0, 0, 0.25));display:flex;flex-direction:column;overflow-y:auto;padding-bottom:50px'>
                            <div class="m-3 pt-2">
                            ...
                            <div class="container d-flex align-items-top" style='width:100%;height:100%;flex-direction:column'>
                                <div class="container-fluid">
                                    <div id="calendar" class="text-decoration-none"></div>
                                </div>
                                <div class="col-12 ms-4 mt-2" style="font-size:21px;font-family:inter;font-weight:700">
                                    Select Available Timeslots:
                                </div>

                                <div class="col-12 ms-4 mt-2 pb-3" style="font-size:22px;font-family:inter;font-weight:700">
                                    <button type="button" onclick="onSched()" class="btn" style="background: rgb(35,64,142);background: linear-gradient(90deg, rgba(35,64,142,1) 35%, rgba(60,148,198,1) 100%);color:white;width:215px;height:34px;font-size:17px;font-family:inter;font-weight:700;border-radius:10px;filter: drop-shadow(0px 4px 11px rgba(0, 0, 0, 0.25))">Schedule</button>
                                </div>
                            </div>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery.ajax({    
            ...
            dataType:"json",
            type:"post",
            url:"cc_timeslotmanage_ajax.php", 
            success: function(xdata){
                    ...
                    for (var key in xdata.retEdit) {
                        ...
                        // console.log(c_event.counseloremail);
