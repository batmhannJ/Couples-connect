                        ...
                        <div style='overflow-y:auto;width:1025px;height:700px;background-color:white;border-radius:30px;filter: drop-shadow(0px 4px 15px rgba(0, 0, 0, 0.25));display:flex;flex-direction:column'>
                            ...
                            <div class="m-3 px-4 d-flex justify-content-center">
                                <div class="col-6" style="margin-left:50px!important">
                                    ...
                                    <input type="text" style='width:328px;height:37px;border-radius:15px;' class="form-control date_picker">
                                </div>
                                ...
                                <div class="col-12 d-flex" style="flex-direction:column">
                                    ...
                                    <?php
                                        ...
                                        while($rs_totalpmo = $stmt_totalpmo->fetch()){                                                
                                            echo "<span style='font-size:24px;font-family:inter'>Total Number of Orientations Sessions Held: ".$rs_totalpmo['xcount']."</span>";
                                        }
                                        ...
                                        while($rs_totalpmo2 = $stmt_totalpmo2->fetch()){
                                            ...
                                            $select_db_totalpmo3 = "SELECT * FROM ext_mf_meiform WHERE usermeiformid='".$rs_totalpmo2['usermeiformid']."' LIMIT 1";
                                            $stmt_totalpmo3	= $link->prepare($select_db_totalpmo3);
                                            $stmt_totalpmo3->execute();
                                            while($rs_totalpmo3 = $stmt_totalpmo3->fetch()){

                                                $select_db_totalpmo4 = "SELECT * FROM mf_venue WHERE venue='".$rs_totalpmo3['venue']."' LIMIT 1";
                                                $stmt_totalpmo4	= $link->prepare($select_db_totalpmo4);
                                                $stmt_totalpmo4->execute();
                                                while($rs_totalpmo4 = $stmt_totalpmo4->fetch()){

                                                    $select_db_totalpmo5 = "SELECT * FROM ext_appointment_info WHERE venue_id='".$rs_totalpmo4['venue_id']."' LIMIT 1";
                                                    $stmt_totalpmo5	= $link->prepare($select_db_totalpmo5);
                                                    $stmt_totalpmo5->execute();
                                                    while($rs_totalpmo5 = $stmt_totalpmo5->fetch()){
                                                        $total_attendees+=$rs_totalpmo5['slots_avail'];
                                                    }
                                                }
                                    ...
                                    ?>
                                    <span style='font-size:20px;font-family:inter;margin-left:20px'>Total Number of Attendees: <?php echo $total_attendees; ?></span>
                                </div>
                            </div>
