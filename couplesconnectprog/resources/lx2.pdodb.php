<?php
    ...
    // FIXED: Added default value to $condition_parameters
    function PDO_UpdateRecord(&$link_id,$tablename,$record_parameters,$condition=' true ',$condition_parameters=null,$debug=false){
