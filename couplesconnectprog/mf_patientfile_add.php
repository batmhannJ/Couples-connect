...
?>
    ...
    <form name='myforms' id="myforms" method="post" target="_self">
            ...
            <tr colspan=1>
                ...
                <td colspan=1 class="td_br" id="td_br">
                    ...
                    <div class="container-fluid d-flex justify-content-center mt-3 mb-3">
                        <div class="row bg-white border rounded shadow" style="width:95%">
                            ...
                            <div class="fs-3 d-flex flex-nowrap container-fluid" style="border-bottom:3px solid black;border-color:#cc0000">
                                <div class="col-3">
                            ...
                            <div class="container-fluid mx-3 my-2 top_header_patient">
                                ...
                                <div class="form-group row my-3" style="font-size:20px;">
                                    ...
                                    <div class="col-12 col-sm-7 me-0 pe-0">
                                        <div class="row">
                                            <label class="col-3">Patient Name:</label>
                                        <div class="col-9">
                                    ...
                                    <div class="col-12 col-sm-4 me-0 pe-0 ms-2">
                                        <div class="row">
                                            <label class="col-5">Date Added:</label>
                                            <div class="col-7">
                                                <input type="text" class="form-control form_custom_input date_picker ms-sm-1 ms-0" id="adddte" name="adddte" autocomplete="off" value="<?php echo $adddte;?>" readonly>
                                            </div>
                                        </div>    
                                    </div>
                                ...
                                <div class="form-group row my-3" style="font-size:20px;">
                                    ...
                                    <div class="col-12 col-sm-4 me-0 pe-0">
                                        <div class="row">
                                    ...
                                    <div class="col-12 col-sm-2 me-0 pe-0">
                                        <div class="row">
                                        <label class="col-4 text-center mx-0 px-0" style="font-size:20px;">Age:</label>
                                        <div class="col-6">
                                    ...
                                    <div class="col-12 col-sm-3 me-0 ps-0 ms-0 pe-0">
                                        <div class="row">
                                            <label class="col-6 me-0 pe-0">
                                                Blood Type:
 
                                            </label>

                                            <div class="col-5 ps-0 ms-0">
                                    ...
                                    <div class="col-12 col-sm-3 ps-0 ms-0">
                                        <div class="row">
        ...
        <input type='hidden' name='pager_xlimit2' id='pager_xlimit2' value="<?php echo $_POST['pager_xlimit'];?>">
                    ...
                    <table class='table'>
                        <tr>
                            <td>
                                ...
                                <div class='clearable-input'>
                                    <input type="text" class="form-control date_picker" name="date_visit_modal" id="date_visit_modal" autocomplete="off" readonly>
                                </div>
                            </td>
    ...
    <script>
            ...
            function view_click(ximage)
            {
                ...
                if(x_extension !== "png" && x_extension !== "jpg" && x_extension !== "gif" && x_extension !== "JPG"  && x_extension !== "PNG" && x_extension !== "GIF" && x_extension !== "jpeg" && x_extension !== "JPEG"){
                ...
                jQuery.ajax({
                    ...
                    success: function(xdata){
                        ...
                        if(xdata["status"] == 1){
                                ...
                                $("#txt_pager_pageno_hidden").val(xdata["new_pageno"]);
                                document.forms.myforms.method = "post";
            ...
            function pat_rec_func(event ,recid){
                ...
                jQuery.ajax({
                    ...
                    success: function(xdata){
                        ...
                        if(xdata["status"] == 0){
                            $("#alert_modal_body").html(xdata["msg"]);
                            $("#alert_modal").modal("show");
            ...
            // $('#pat_rec_modal').on('shown.bs.modal', function (e) {
            ...
            //     var popup = document.getElementById('crudModal');
            ...
            // $('#pat_rec_modal').on('hidden.bs.modal', function (e) {

            //     $("#pat_rec_modal #ui-datepicker-div").remove();
            //     $("#pat_rec_modal  .date_picker").datepicker( "destroy" );
            // });
