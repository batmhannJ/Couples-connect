                                ...
                                echo "<tr>";
                                        ...
                                        echo "<td>";
                                            echo "<select class='form-control w-75 ms-2 select_date'>";
                                                ...
                                                mf_appointment_info.userid = mf_prog_users.userid LEFT JOIN mf_venue ON ext_appointment_info.venue_id = mf_venue.venue_id  WHERE mf_prog_users.userid='".$row_xid['userid']."'  AND mf_venue.venue='".$row_xid['venue']."' GROUP BY ext_appointment_info.clinic_date";
                                    ...
                                    echo "<tr style='margin-top:5px'>";
                                        ...
                                        echo "<td class='px-3'>";
                                            echo "<select class='form-control' name='form_1[".$mei_form1_counter."][option]' id='form_1[".$mei_form1_counter."][option]'>";
                                                echo "<option disabled selected value='' class='text-center'> - </option>";
