            ...
            if($_POST['event_action'] == 'first_load'){
                ...
                if($_POST['ext_recid'] == $row_xid['ext_recid']){
                    ...
                    $ret['html'].= "<td>";
                        ...
                        ext_appointment_info.appointment_info_id = mf_appointment_info.appointment_info_id
                        WHERE ext_appointment_info.week_day='".$weekday."' AND mf_appointment_info.userid='".$_POST['counselorid']."' AND ext_appointment_info.venue='".$row_xid['venue']."'  AND mf_appointment_info.sched_type='".$act_status2."' ORDER BY time_from ASC";
            ...
            $ret['html'].= "<td>";
                $ret['html'].= "<select class='form-control w-75 ms-2 select_date' disabled>";
                    ...
                    foreach ($ret['retEdit'] as $event => $key) {
                        ...
                        $ret['html'] .= "<option disabled".$xseleted." 
                        data-xslotsavail='".$row_xid['slots_avail']."' 
                        data-xdate='" . $key['date'] . "' 
                        data-xcounselorid='".$key['userid']."' 
                        data-xrecid='".$key['ext_recid']."'
